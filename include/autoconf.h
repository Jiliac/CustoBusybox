 ...
 */
#define AUTOCONF_TIMESTAMP "2016-07-12 17:41:12 KST"
...
#define ENABLE_CKERNEL_CALL 1
#ifdef MAKE_SUID
# define IF_CKERNEL_CALL(...) __VA_ARGS__ "CONFIG_CKERNEL_CALL"
#else
# define IF_CKERNEL_CALL(...) __VA_ARGS__
#endif
#define IF_NOT_CKERNEL_CALL(...)
