...
IF_MKPASSWD(APPLET_ODDNAME(mkpasswd, cryptpw, BB_DIR_USR_BIN, BB_SUID_DROP, cryptpw))
...
IF_BLKDISCARD(APPLET(blkdiscard, BB_DIR_USR_BIN, BB_SUID_DROP))
...
IF_CKERNEL_CALL(APPLET(ckernel_call,BB_DIR_BIN, BB_SUID_DROP))
