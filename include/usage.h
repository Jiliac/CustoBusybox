...
#ifndef BB_USAGE_H
#define BB_USAGE_H 1
#define ckernel_call_trivial_usage  "None"
#define ckernel_call_full_usage "None"
...
#define gzip_trivial_usage \
       "[-cf" IF_GUNZIP("d") IF_FEATURE_GZIP_LEVELS("123456789") "] [FILE]..." \
